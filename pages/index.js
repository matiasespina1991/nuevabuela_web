      ...
      <div className="main-section-container">
        ...
        <main>
          <div className="home-our-brand-featured-images-container">
            <div className="home-our-brand-featured-image-left">
            </div>
            <div className="home-our-brand-featured-image-right">
            </div>
          </div>
          ...
          <div className="separator">
            <Image src="/images/loading-plus.png" alt="" width="30" height="30" />
          </div>
          <div className="home-about-us-featured-images-container">
            <Image src="/images/about-us-image.png" alt="" width="521" height="295" />
          </div>
          <div className="about-us">
            <h1>About Us</h1>
            <p>
              Everything started when we met and crossed our paths in London and realised that we shared the same passions and dreams.
              <br />
              <br />
              After completing our interior design studies in different cities, we met again in Berlin, where we decided to put our ideas together, and that&apos;s where <strong>nuevabuela</strong> begins. 
              <br />
              <br />
              <strong>nuevabuela</strong> is a brand full of life and personality that was born from the desire to create a project and express our creativity through our work.
            </p>
          </div>
        </main>
        ...
        <footer>
          <div className="contact-us-footer">
            ...
            <div className="footer-social-icons-container">
              <div>
                <Image src="/images/instagram-icon.svg" alt="" width="40" height="40"/>
              </div>
              <div>
                <Image src="/images/pinterest-icon.svg" alt="" width="40" height="40"/>
              </div>
              <div>
                <Image src="/images/whatsapp-icon.svg" alt="" width="40" height="40"/>
              </div>
            </div>
          </div>
        </footer>
